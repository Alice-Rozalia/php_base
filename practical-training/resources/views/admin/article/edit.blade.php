...
<div class="weadmin-body">
    <form enctype="multipart/form-data" class="layui-form" action="{{ route('admin.article.update', $article) }}" method="post">
        @method('PUT')
        @csrf
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input id="a_title" type="text" value="{{ $article->title }}" name="title" lay-verify="required" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input id="a_summary" type="text" value="{{ $article->summary }}" name="summary" lay-verify="required" autocomplete="off"
                       class="layui-input" style="width: 700px;">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div style="min-height: 300px;width: 850px;" id="editor">
                    <p>
                        {{ $article->content }}
                    </p>
                </div>
        ...
        <div class="layui-form-item">
            ...
            <button class="layui-btn" lay-submit="" id="subBtn">确认修改</button>
        </div>
    </form>
