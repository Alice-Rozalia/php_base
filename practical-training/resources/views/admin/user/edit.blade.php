...
<div class="weadmin-body">
    <form class="layui-form" action="{{ route('admin.user.edit', $model) }}" method="post">
        @method('PUT')
        @csrf
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_phone" value="{{ $model->phone }}" name="phone" lay-verify="required|phone"
                       autocomplete=""
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_email" value="{{ $model->email }}" name="email" autocomplete="off"
                       class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="originalPassword" lay-verify="required|pass" autocomplete="off"
                       class="layui-input">
            </div>
